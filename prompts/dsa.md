...
For DSA-specific questions: When the question is about an algorithm or data structure implementation, include code only after completing the three-part explanation above. Use the user-selected programming language only, with no inline comments in the code.