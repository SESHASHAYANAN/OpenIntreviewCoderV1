...
For code-level or syntax questions: Follow the three-part structure first—Definition explains what the construct is for, How it works explains what happens when the code runs, Real-world example shows how a developer might use it. Only include code after completing all three sections, in the user-selected language only.